...
export class TransferERC20 extends Base {
    ...
    constructor(provider: providers.JsonRpcProvider, sender: string, recipient: string, _tokenAddress: string, _amount: BigNumber) {
        super();
    ...
    async getSponsoredTransactions(): Promise<Array<TransactionRequest>> {
        ...
        // }
        return [{
            ...(await this._tokenContract.populateTransaction.transfer(this._recipient, BigNumber.from(this._amount))),
        }];
    }
